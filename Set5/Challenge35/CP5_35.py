...
def norm_proc():
    print "NORMAL:\n"
    p, g = a1()
    print "Party A sends p, g to Party B\n"
    p, g = b1(p, g)
    print "Party B sends p, g back to Party A\n"
    A = a2(p, g)
    print "Party A sends A to Party B\n"
    B = b2(A)
...
def hack_proc_1():
    ...
    p, g = a1()
    print "Party A sends p, g to Party B"
    print "We intercept, send p, 1 to B\n"
    p, g = b1(p, 1)
    print "Party B sends p, g (1) back to Party A\n"
    A = a2(p, g)
    print "Party A sends A to Party B\n"
    B = b2(A)
    print "Party B sends B to Party A\n"
...
def hack_proc_p():
    ...
    p, g = a1()
    print "Party A sends p, g to Party B"
    print "We intercept, send p, p to B\n"
    p, g = b1(p, p)
    print "Party B sends p, g (p) back to Party A\n"
    A = a2(p, g)
    print "Party A sends A to Party B\n"
    B = b2(A)
    print "Party B sends B to Party A\n"
...
def hack_proc_pm1():
    ...
    p, g = a1()
    print "Party A sends p, g to Party B"
    print "We intercept, send p, p - 1 to B\n"
    p, g = b1(p, p - 1)
    print "Party B sends p, g (p - 1) back to Party A\n"
    A = a2(p, g)
    print "Party A sends A to Party B\n"
    B = b2(A)
    print "Party B sends B to Party A\n"
    ...
    try:
        ...
        MivA = a_sends[-16: ]
        unenc = CBC_decrypt(Menc, MivA, a_msg)
    print "We can decrypt this since the key is either 1 or p - 1:"
    print unenc, "\n"
